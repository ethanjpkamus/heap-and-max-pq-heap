...
void test_shell_sort() {
  ...
  test_sort_from_file<std::string>("shell_sort -- reversed", "words3.txt", shell_sort<std::string>(), rev_comparator<std::string>());
}
*/
//------------------------------------------------------------------------------------
/*
...
void test_quick_sort() {
  ...
  test_sort_from_file<std::string>("quick_sort_3way -- reversed", "words3.txt", quick_sort_3way<std::string>(), rev_comparator<std::string>());
  test_sort_from_file<std::string>("quick_sort_3way", "dutch.txt", quick_sort_3way<std::string>());
  test_sort_from_file<std::string>("quick_sort_3way -- reversed", "dutch.txt", quick_sort_3way<std::string>(), rev_comparator<std::string>());
...
//------------------------------------------------------------------------------------
void test_max_pq_heap() {
  max_pq_heap<std::string>::test_file("pq.txt");
  max_pq_heap<std::string>::test_file("long_pq.txt");
  max_pq_heap<std::string>::test_initializer_list(
      { "A", "B", "C", "D", "E", "F", "G", "H", "I", "J" });

  max_pq_heap<std::string>
      pqheap({ "one", "two", "three", "four", "five", "six", "seven", "eight" },
